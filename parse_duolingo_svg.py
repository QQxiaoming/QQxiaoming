...
append_list = [
    # add your data here
    ["2023-03-26", 450,],  # sunday
    ["2023-03-27", 94,],   # monday
    ["2023-03-28", 182,],  # tuesday
    # ["2023-03-29", 0,],  # wednesday
    # ["2023-03-30", 0,],  # thursday
    # ["2023-03-31", 0,],  # friday
    # ["2023-04-01", 0,],  # saturday
]
...
def parse_svg(svg_file):
    ...
    sum_xp_2022 = 0
    for i in range(20+365+17, 20+365+17+365):
    ...
    # 2023 year data output, support check and append data
    sum_xp_2023 = 0
                    ...
                    if(len(append_list) != 0):
                        for j in range(0, len(append_list)):
                            if(append_list[j][0] == data[0]):
                                ...
                                sum_xp_2023 += append_list[j][1]
    
    print("sum_xp_2022:", sum_xp_2022, "svg:" ,root[20+365+1].text)
    print("sum_xp_2023:", sum_xp_2023, "svg:" ,root[4].text)
    if(root[4].text != str(sum_xp_2023)+" XP"):
        root[4].text = str(sum_xp_2023)+" XP"
